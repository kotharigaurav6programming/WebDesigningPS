...
function Navbar(){
    ...
    useEffect(()=>{
        ...
        if(navShow=="home"){
            ...
            setMenuItem(<div style={{height:"35px",backgroundColor:"black",padding:"10px"}}>
                <Link style={{color:"white",textDecoration:"none",marginLeft:"50px",fontSize:"20px"}} to='/'>Home</Link>
                <Link style={{color:"white",textDecoration:"none",marginLeft:"50px",fontSize:"20px"}} to='/'>View All Users</Link>
                <Link style={{color:"white",textDecoration:"none",marginLeft:"50px",fontSize:"20px"}} to='/'>Update Profile</Link>
                <Link style={{color:"white",textDecoration:"none",marginLeft:"50px",fontSize:"20px"}} to='/'>DeActivate A/C</Link>
                <Link style={{color:"white",textDecoration:"none",marginLeft:"50px",fontSize:"20px"}} to='/'>Logout</Link>
            </div>);
        }
        },10);
